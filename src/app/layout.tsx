...
export const metadata: Metadata = {
  title: "USA Auto Import - Professional Turn-Key Car Import Service",
  description: "Professional car importing service from USA. Complete turn-key solution handling paperwork, shipping, customs. Import your dream American vehicle hassle-free.",
  keywords: "USA car import, American car import, vehicle import service, car shipping USA, auto import specialist, turn-key car import",
  robots: {
    index: true,
    follow: true
  },
  openGraph: {
    title: "USA Auto Import - Professional Car Import Service",
    description: "Complete turn-key car importing service from USA. We handle everything from sourcing to delivery.",
    siteName: "USA Auto Import",
    type: "website",
    images: [
      {
        url: "https://webuild-dev.s3.eu-north-1.amazonaws.com/users/user_35bov8zjOkdGcVDNMecOsQMxHeM/uploaded-1763395055231-0ki8sa2i.jpg",
        alt: "Luxury sports car import"
      }
    ]
  },
  twitter: {
    ...
    title: "USA Auto Import - Professional Car Import Service",
    description: "Complete turn-key car importing service from USA. We handle everything from sourcing to delivery.",
    images: ["https://webuild-dev.s3.eu-north-1.amazonaws.com/users/user_35bov8zjOkdGcVDNMecOsQMxHeM/uploaded-1763395055231-0ki8sa2i.jpg"]
  }
};
